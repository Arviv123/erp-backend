...
async function getCustomerInvoices(id: string) { const r = await api.get(`/crm/customers/${id}/invoices`); return r.data; }
                ...
                <tbody className="divide-y divide-gray-100">
                  {invoices.map((inv: any) => (
                    <tr key={inv.id} className="hover:bg-gray-50">
                      ...
                      <td className="px-3 py-2.5 font-medium">{fmtCurrency(inv.total)}</td>
